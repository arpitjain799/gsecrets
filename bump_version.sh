...
echo ""
echo "sed -i -e 's/${OLD_VERSION}/${NEW_VERSION}/g' gsecrets/__version__.py"
...
${DASHES}\\
' CHANGELOG.md"
echo "rm -f gsecrets/__version__.py-e"
...
echo "git push"
echo ""
echo "rm -r dist build gsecrets.egg-info"  # reset build dirs
